        ...
        <div class="row">
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Charity types</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mt-1 mb-1">Add Charity Type</h4>
                    </div>
                    <div class="card-body">
                        <form method="post" action="#">
                            <div class="form-group">
                                <label for="CharityType">Charity type</label>
                                <input type="text" placeholder="Enter Charity type" name="CharityType" class="form-control" required>
                            </div>
                            
                            <div class="form-group text-right">
                                <input type="submit" class="btn btn-success" value="save Charity type">
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mt-1 mb-1">Charity Types List</h4>
                    </div>
                    <div class="card-body">
