        ...
        <div class="row">
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ambulance types</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mt-1 mb-1">Add Ambulance Type</h4>
                    </div>
                    <div class="card-body">
                        <form method="post" action="#">
                            <div class="form-group">
                                <label for="AmbulanceType">Ambulance type</label>
                                <input type="text" placeholder="Enter Ambulance type" name="AmbulanceType" class="form-control" required>
                            </div>
                            
                            <div class="form-group text-right">
                                <input type="submit" class="btn btn-success" value="save Ambulance type">
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mt-1 mb-1">Ambulance Types List</h4>
                    </div>
                    <div class="card-body">
