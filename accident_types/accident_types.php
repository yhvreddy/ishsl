        ...
        <div class="row">
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Accident types</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mt-1 mb-1">Add Accident Type</h4>
                    </div>
                    <div class="card-body">
                        <form method="post" action="#">
                            <div class="form-group">
                                <label for="accidentType">Accident type</label>
                                <input type="text" placeholder="Enter accident type" name="accidentType" class="form-control" required>
                            </div>
                            
                            <div class="form-group text-right">
                                <input type="submit" class="btn btn-success" value="save accident type">
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mt-1 mb-1">Accident Types List</h4>
                    </div>
                    <div class="card-body">
